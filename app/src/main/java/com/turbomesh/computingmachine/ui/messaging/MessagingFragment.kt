...
class MessagingFragment : Fragment() {
    ...
    // Scoped to the Activity so MainActivity can observe unreadCount
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Swipe-left to delete — skip date-header rows
        ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            override fun getSwipeDirs(
                recyclerView: RecyclerView,
                viewHolder: RecyclerView.ViewHolder
            ): Int {
                return if (messageAdapter.isMessageAt(viewHolder.adapterPosition))
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                val msg = messageAdapter.messageAt(viewHolder.adapterPosition) ?: return
            ...
            object : android.widget.AdapterView.OnItemSelectedListener {
                override fun onItemSelected(
                    ...
                    viewModel.selectDestination(
                        destinations.getOrNull(position) ?: MeshMessage.BROADCAST_DESTINATION
                    )
                }
